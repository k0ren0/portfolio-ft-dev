...
const About = () => {
  // Обновленный стиль для блоков с технологиями: центрирование содержимого, адаптивный отступ, и добавление тени при наведении
  ...
  // Адаптивный размер логотипа с центрированием и гармоничным распределением в зависимости от размера экрана
